...
public class EditOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        OrderAccess ordAc = new OrderAccess();
        
        Order ord = new Order(ordId,paidStatus, orderStatus, actDate);
        
        ordAc.editOrder(ord);
        
        request.setAttribute("FoundOrder", OrderAccess.getOrderDet(ordId));
