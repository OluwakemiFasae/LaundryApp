...
public class login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        emplDataAccess empcheck = new emplDataAccess();
        
        String usename = request.getParameter("username");
        String initpass = request.getParameter("password");
   
        String pass = check.hashPassword(initpass);
        

        Employee emp = new Employee();
        emp.setUsername(usename);
        emp.setPassword(pass);
        
        if (empcheck.emplogin(usename, pass)== true) {  
            ...
            Cookie msg = new Cookie("username", usename);
            response.addCookie(msg);
            
            if (check.checkAdmin(usename, pass)) {
