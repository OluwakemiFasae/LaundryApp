<%-- 
    ...
    Created on : 30-Oct-2018, 10:41:18
    Author     : OLUWAKEMI
--%>
...
<%@ include file = "header.jsp" %>
        <div class="container">
        <!--Search Form -->
            <form action="SearchOrderD" method="get" id="seachOrder" role="form" >
                
                <div class="form-group col-xs-5">
                    <input type="date" name="dateSearch" id="searchOrder" class="form-control" 
                           placeholder="2018-03-11"/>                    
                </div>
